...
Q = np.diag(np.array([1e-1, 1e-3, 1e-3, 1e-3, 1e-5, 1]))   # state cost matrix
R = np.diag([80.0])                    # control cost matrix
QN = np.diag(np.array([100, 1e-3, 1e-1, 1e-1, 1e-5, 1000]))                         # terminal state cost matrix
s_goal = np.array([120, 20, 0, np.deg2rad(5), 0, 0])     # goal state
